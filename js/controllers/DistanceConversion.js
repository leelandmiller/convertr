conversionControllers.controller('DistanceConversion', function($scope, materializeInput) {

	//The available units to convert from and to
	$scope.distanceUnits = [{name:"Meters"}, {name:"Kilometers"}, {name: "Inches"}, {name: "Feet"}, {name: "Yards"}, {name: "Miles"}];
