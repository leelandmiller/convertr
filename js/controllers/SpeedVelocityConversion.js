conversionControllers.controller('SpeedVelocityConversion', function($scope, materializeInput) {

	//The available units to convert from and to
	$scope.speedVelocityUnits = [{name:"Meters/Second"}, {name:"Kilometers/Hour"}, {name: "Miles/Hour"}, {name: "Feet/Second"}];
