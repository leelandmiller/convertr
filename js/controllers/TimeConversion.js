conversionControllers.controller('TimeConversion', function($scope, materializeInput) {

	//The available units to convert from and to
	$scope.timeUnits = [{name:"Seconds"}, {name: "Minutes"}, {name: "Hours"}, {name: "Days"}, {name: "Weeks"}, {name: "Months"}, {name: "Years"}];
