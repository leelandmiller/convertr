conversionControllers.controller('VolumeConversion', function($scope, materializeInput) {

	//The available units to convert from and to
	$scope.volumeUnits = [{name:"Liters", mathjsLabel: 'liter'}, {name:"Meters Cubed", mathjsLabel: 'm3'}, {name:"Centimeters Cubed", mathjsLabel: 'cc'}, {name:"Inches Cubed", mathjsLabel: 'cuin'}, {name:"Feet Cubed", mathjsLabel: 'cuft'}, {name:"Yards Cubed", mathjsLabel: 'cuyd'}, {name:"Teaspoons", mathjsLabel: 'teaspoon'}, {name:"Tablespoon", mathjsLabel: 'tablespoon'}];
